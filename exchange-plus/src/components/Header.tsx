...
const Header: React.FC<HeaderProps> = ({ onEditToggle, onAddCurrency, isEditMode }) => {
  return (
      ...
      <div className="flex items-center justify-between h-[44px]">
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="text-[17px] font-semibold text-[#007AFF] active:opacity-50 transition-opacity cursor-pointer flex items-center gap-1"
